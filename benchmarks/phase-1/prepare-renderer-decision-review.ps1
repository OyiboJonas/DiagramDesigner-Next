...
$culled5kUpdateP95 = Get-OptionalPropertyValue $culled5k "update_ms_p95"
$culled20kUpdateP95 = Get-OptionalPropertyValue $culled20k "update_ms_p95"
...
| --- | ---: | ---: | ---: | ---: | --- | --- |
| 5,000 culled | $(Format-NumberInvariant $culled5kUpdateP95) ms | $(Format-NumberInvariant $culled5k.frame_ms_p95) ms | $($culled5k.long_tasks_observed) | $($culled5k.dom_nodes_max) | $($culled5k.stage_physical_px.width)x$($culled5k.stage_physical_px.height) | <pass / fail / repeat> |
| 20,000 culled | $(Format-NumberInvariant $culled20kUpdateP95) ms | $(Format-NumberInvariant $culled20k.frame_ms_p95) ms | $($culled20k.long_tasks_observed) | $($culled20k.dom_nodes_max) | $($culled20k.stage_physical_px.width)x$($culled20k.stage_physical_px.height) | <pass / fail / repeat> |
